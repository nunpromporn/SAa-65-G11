...
async function GetTenderness() {
  ...
  let res = await fetch(`${apiUrl}/tenderness`, requestOptions)
    .then((response) => response.json())
    .then((res) => {
      if (res.data) {
        return res.data;
...
async function Symptom(data: SymptomInterface) {
  const requestOptions = {
    method: "POST",
    headers: {
      Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  let res = await fetch(`${apiUrl}/symptom`, requestOptions)
    .then((response) => response.json())
    .then((res) => {
      if (res.data) {
        return res.data;
